...
func (o *GetNodeURL) Build() (*url.URL, error) {
	...
	var _path = "/node/{roomNum}"

	roomNum := swag.FormatInt64(o.RoomNum)
	if roomNum != "" {
		_path = strings.Replace(_path, "{roomNum}", roomNum, -1)
	} else {
		return nil, errors.New("roomNum is required on GetNodeURL")
	}
